...
; 10.7.2014 für Tria/TriaZeit modifiziert.
...
;für Tria/TriaZeit modifiziert:
SetupAppRunningError=Das Setup hat entdeckt, dass %1 zur Zeit ausgeführt wird.%n%nBitte schließen Sie %1, und klicken Sie auf "OK", um fortzufahren, oder auf "Abbrechen", um das Setup zu beenden.
...
;für Tria/TriaZeit modifiziert:
UninstallAppRunningError=Die Deinstallation hat entdeckt, dass %1 zur Zeit ausgeführt wird.%n%nBitte schließen Sie %1, und klicken Sie auf "OK", um fortzufahren, oder auf "Abbrechen", um die Deinstallation zu beenden.
...
;für Tria/TriaZeit modifiziert:
WelcomeLabel2=Dieser Assistent wird jetzt [name/ver] auf Ihrem Computer installieren.%n%nBitte beenden Sie alle Anwendungen, bevor Sie mit dem Setup fortfahren.
