...
begin
  try
    {try  SSL geht nicht wegen veraltetes Protokoll
    ...
    if ContainsStr(FPadProgName, Application.Title) and // Tria/TriaZeit
       SameStr(FPadProgVersion,ProgVersion.JrNr) then SetStatus(usUpToDate)
    else
    begin
    ...
    case Status of
      ...
      begin
        ...
        if TriDatei.Modified then
          case TriaMessage(Self,'Änderungen in Datei  "'+TriDatei.Path+'"  speichern?',
