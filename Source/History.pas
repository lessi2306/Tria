...
- TlnColl.SortString: zusätzlicher SortMode: smTlnMschGroesse
...
MannsObj:
- neuer Proc: InitMschGrListe für Sortierung nach Mannschaftsgröße

AlgConst:
- zusätzlicher SortMode: smTlnMschGroesse und Spalte: spMschGroesse
...
TlnObj:
- TTlnObj: FVereinPtr zusätzlich, FmannschName in MannschNamePtr geändert
  zusätzlich auch GetVerein, SetVereinPtr, SetVerein

VeranObj:
- TVeranstObj.VereinColl zusätzlich
