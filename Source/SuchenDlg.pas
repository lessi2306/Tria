...
begin
  case Spalte of
    spName,spVName,spLand,spMannsch,spMschName: Result := true;
    else Result := false;
  end;
end;
//..............................................................................
  ...
  try
    case GetSpalte of
      ...
      begin
        ...
        if Veranstaltung.TlnColl.SucheTln(Tln,S,VName,Verein,MannschName,Wettk) <> nil then
        begin
          HauptFenster.LstFrame.TriaGrid.FocusedItem := Tln; // Tln bei AllesErsetzen zeigen
          HauptFenster.FocusedTln := Tln;
          HauptFenster.RefreshAnsicht;  // aktuelle Sortierung vor Meldung zeigen
      ...
      begin
        ...
        if Veranstaltung.TlnColl.SucheTln(Tln,Name,S,Verein,MannschName,Wettk) <> nil then
        begin
          HauptFenster.LstFrame.TriaGrid.FocusedItem := Tln; // Tln bei AllesErsetzen zeigen
          HauptFenster.FocusedTln := Tln;
          HauptFenster.RefreshAnsicht;  // aktuelle Sortierung vor Meldung zeigen
      ...
      begin
        ...
        if Veranstaltung.TlnColl.SucheTln(Tln,Name,VName,S,MannschName,Wettk) <> nil then
        begin
          HauptFenster.LstFrame.TriaGrid.FocusedItem := Tln; // Tln bei AllesErsetzen zeigen
          HauptFenster.FocusedTln := Tln;
          HauptFenster.RefreshAnsicht;  // aktuelle Sortierung vor Meldung zeigen
      ...
      begin
        ...
        if Veranstaltung.TlnColl.SucheTln(Tln,Name,VName,Verein,S,Wettk) <> nil then
        begin
          HauptFenster.LstFrame.TriaGrid.FocusedItem := Tln; // Tln bei AllesErsetzen zeigen
          HauptFenster.FocusedTln := Tln;
          HauptFenster.RefreshAnsicht;  // aktuelle Sortierung vor Meldung zeigen
      ...
      spMschName : // MschAnsicht, Name in MannschNameColl, für alle Tln in Wettk ändern
      begin
        S := ErsetzeText(MannschName);
