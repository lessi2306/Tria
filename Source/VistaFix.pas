...
const
  ...
  TestFont  = 'Segoe Script';  // nur für Test
  XPFont    = 'Tahoma';        // XP default
  AltFont   = 'MS Sans Serif'; // default für ältere Systeme
...
- Älter:  Name = MS Sans Serif, Size = 8

Alle Defaults für Vista gesetzt. Wenn <> Vista Fonts auf Tahoma und Size-1 setzen
}
...
begin
  ...
  {else AFont.Name := TestFont}; // nur für Test
end;
