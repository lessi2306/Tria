...
//------------------------------------------------------------------------------
// nur prüfungsrelevante Parameter
begin
...
begin
  ...
  if (Tab = nil) and // nur bei Ok-Button, nicht bei Page-Wechsel
     ((RfidModus <> RfidRB.Checked) or // Rfid geändert
    ...
    if TriaMessage(Self,'Die RFID-Einstellungen wurden geändert.'+#13+
                  'Die bisher eingetragenen RFID-Codes löschen?',
...
begin
  ...
  begin
    ...
    // nur Update wenn sich was ändert
