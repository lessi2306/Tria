...
type
  ...
  public
    ...
    procedure Init(NameNeu,VNameNeu,StrasseNeu,HausNrNeu,PLZNeu,OrtNeu,
                   MannschNameNeu,EMailNeu:String);
  ...
  public
    ...
    function    GetSMld(NameNeu,VNameNeu,MannschNameNeu:String): TSMldObj;
...
//==============================================================================
function TSMldObj.GetMannschName: String;
//==============================================================================
begin
...
begin
  with TSMldObj(Item) do
    case SortMode of
      smSMldName     : Result := FName+' '+FVName+' '+MannschName;
      smSMldMschName : Result := MannschName+' '+FName+' '+VName;
      else           Result := '';
    end;
end;
...
//==============================================================================
function TSMldColl.GetSMld(NameNeu,VNameNeu,MannschNameNeu:String): TSMldObj;
//==============================================================================
var i : Integer;
begin
  Result := nil;
  for i:=0 to Count-1 do with GetPItem(i) do
    if StrGleich(FName,NameNeu) and StrGleich(FVName,VNameNeu) and StrGleich(MannschName,MannschNameNeu) then
    begin
      Result := GetPItem(i);
      Exit;
    end;
